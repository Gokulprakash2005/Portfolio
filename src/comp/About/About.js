...
function About()
{
    return(
        ...
        <h1>About Me</h1> 
        <p> Hello, I'm Gokul Prakash, a passionate web developer with hands-on 
            ...
            mastering tools like Bootstrap for responsive design and Git for version control..<a href="https://github.com/Gokulprakash2005?tab=repositories">Click here</a> </p> 
        </div>
        </div>
        </>
    )
