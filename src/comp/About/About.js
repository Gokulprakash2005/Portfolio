    ...
    return (
        <div className="about-body">
            <div className="About-head">
                ...
                <h1>Hello You</h1>
                <h5 className="about-text"> My Name is Gokul Prakash "As an emerging web developer, I'm learning full-stack technologies
                    ...
                    Recently, I've been fascinated by the efficiency and utility of css frameworks Bootsrap version 5 in speeding up UI development and enhancing user experience. Concurrently, I'm honing my version control skills using Git and collaborating on projects through GitHub.
                    Looking forward, I aim to apply these skills to create innovative solutions and contribute to the evolving landscape of web development. 
                    <span style={{color:"red"}}>For More Updates</span>
                </h5>
